...
/**
 * Guards the service-to-service routes (/api/fares/internal/**, /api/payments/internal/**)
 * with the shared X-Internal-Api-Key header.
 */
@Component
@Slf4j
public class InternalApiKeyFilter extends OncePerRequestFilter {
    ...
    public static final List<String> INTERNAL_PATH_PREFIXES =
            List.of("/api/fares/internal", "/api/payments/internal");
    ...
    protected void doFilterInternal(
        ...
        if (INTERNAL_PATH_PREFIXES.stream().noneMatch(path::startsWith)) {
