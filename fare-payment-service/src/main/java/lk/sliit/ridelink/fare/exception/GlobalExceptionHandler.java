...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePaymentDeclined(PaymentDeclinedException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleDuplicateKey(DuplicateKeyException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.CONFLICT, "A payment already exists for this ride", request.getRequestURI());
    }
    ...
    public ResponseEntity<ErrorResponse> handleConcurrentUpdate(OptimisticLockingFailureException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.CONFLICT,
                "The payment was modified by another request. Please retry.", request.getRequestURI());
    }
    ...
    /** Unparseable JSON, or an unknown enum value such as "method": "BITCOIN". */
    ...
    /** A query or path parameter of the wrong type, e.g. ?status=REFUNDED. */
    @ExceptionHandler(MethodArgumentTypeMismatchException.class)
    public ResponseEntity<ErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException ex, HttpServletRequest request) {
        log.warn("Parameter type mismatch: {}", ex.getMessage());
        return buildResponse(HttpStatus.BAD_REQUEST,
                "Invalid value '" + ex.getValue() + "' for parameter '" + ex.getName() + "'", request.getRequestURI());
    }
