...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDuplicateKey(DuplicateKeyException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.CONFLICT, "Email is already registered", request.getRequestURI());
    }
    ...
    public ResponseEntity<ErrorResponse> handleConcurrentUpdate(OptimisticLockingFailureException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.CONFLICT,
                "The account was modified by another request. Please retry.", request.getRequestURI());
    }
    ...
    /** Unparseable JSON, or an unknown enum value such as "role": "PILOT". */
    ...
    /** A query or path parameter of the wrong type, e.g. ?role=PILOT. */
